...
import tingting.xiazhenjie.mysmartrefreshlayout.adapter.BaseRecyclerAdapter;
import tingting.xiazhenjie.mysmartrefreshlayout.R;
import tingting.xiazhenjie.mysmartrefreshlayout.adapter.SmartViewHolder;

import static android.R.layout.simple_list_item_2;

/**
 * SmartRefreshLayout + ListView + 自定义Header
 */
public class SmartRefListViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //自定义Header布局，不是下拉刷新的布局
        View inflate = LayoutInflater.from(getApplicationContext()).inflate(R.layout.listview_header_layout, null);
        ...
        mAdapter.setOnItemClickListener((parent, view, position, id) -> {
            Toast.makeText(this, "你点击了第"+position+"个", Toast.LENGTH_SHORT).show();
//            BottomSheetDialog dialog=new BottomSheetDialog(StandardExampleActivity.this);
