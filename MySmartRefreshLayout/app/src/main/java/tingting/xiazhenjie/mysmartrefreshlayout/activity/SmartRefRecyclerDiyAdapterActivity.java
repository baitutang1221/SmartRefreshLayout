...
import tingting.xiazhenjie.mysmartrefreshlayout.adapter.RecycleAdapter3;
import tingting.xiazhenjie.mysmartrefreshlayout.beans.Person;

/**
 * SmartRefreshLayout + RecyclerView  + 自定义Header + 封装Adapter
 */
public class SmartRefRecyclerDiyAdapterActivity extends AppCompatActivity {

    private SmartRefreshLayout mRefreshLayout;
    private RecycleAdapter3 recycleAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recycleAdapter = new RecycleAdapter3(this,mList);
    ...
    private final Handler mHandler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            switch (msg.what){
                case 1:         //刷新加载
                    ArrayList<Person> mList  = (ArrayList<Person>) msg.obj;
                    ...
                    break;
                case 2:         //加载更多
                    ArrayList<Person> mLoadMoreDatas = (ArrayList<Person>) msg.obj;
